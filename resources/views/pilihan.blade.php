...
<nav class="navbar bg-light mb-3 shadow-sm g-4">
  <form class="container-fluid justify-content-start">
    @if (request('category'))
      <a href="/pilihan" class="btn btn-sm btn-secondary me-2 mb-2" type="button">All</a>
    @else
      <a href="/pilihan" class="btn btn-success me-2 mb-2" type="button">All</a>
    @endif
    ...
    <?php $i = 0?>
      @foreach ($kategori->take(10) as $kate)
        ...
        <a href="/pilihan?category={{ $kate->slug }}" class="btn btn-outline-success me-2 mb-2" type="button">{{ $kate->nama }}</a>        
        @else
        <a href="/pilihan?category={{ $kate->slug }}" class="btn btn-sm btn-outline-secondary me-2 mb-2" type="button">{{ $kate->nama }}</a>
        @endif
      @endforeach
...
@foreach ($pilihan as $pilih)
  <div  class="col">  
    <div style="height: 280px; width:155px;" class="card shadow">
